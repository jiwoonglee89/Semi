...
<body bgcolor="${bodyback_c}>">
	<form method="get" action="Per_fileModify.do?f_filename=${f_filename}"
		name="Fileinput" onsubmit="return checkIt()">
		...
		<table width="600" border="1" cellspacing="0" cellpadding="3"
			...
			<tr>
				...
				<td width="400"><input type="text" size="10" maxlength="20"
					value="${fbean.f_title}"></td>
			</tr>

			<td width="200" bgcolor="${value_c}">파일 :</td>
			<td width="400" bgcolor="${value_c}"><input type="file"
				name="file" /> <br /></td>
			</tr>
			...
			<tr>
				...
				<td width="400" bgcolor="${value_c}"><input type="textarea"
					name="f_description" value="${fbean.f_desciption}"></td>
			</tr>
			...
			<tr>
				...
				<select name="p_category">
						<option>디자인분류</option>
						<option value="sanup"
							selected="${fbean.f_categoy eq 'sanup'?'selected':''}">
							>산업디자인</option>
			...
			<tr>
				...
				<td width="400" bgcolor="${value_c}"><input type="submit"
					value="업로드"></td>
			</tr>
		</table>
